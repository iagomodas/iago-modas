...
import { CheckCircle2, ChevronLeft, Clock3, Loader2, LogIn, PackageCheck, ShoppingBag, XCircle } from "lucide-react";
...
function statusFor(order: CustomerOrder) {
  if (order.payment_status === "cancelled" || order.order_status === "cancelled") return { label: "CANCELIZADO", className: "text-red-200", icon: XCircle };
