-- IAGO MODAS: endurecimento defensivo do checkout manual.
-- O site não processa cartões nem boletos; pedidos dependem de login Google.
...
begin
  ...
  if p_payment_method::text not in ('pix', 'cash') then
