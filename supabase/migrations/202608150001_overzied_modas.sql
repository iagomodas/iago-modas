...
create table public.storefront_settings (
  ...
  promotion_cta_label text not null,
  promotion_cta_path text not null,
  highlights_eyebrow text not null,
  highlights_title text not null,
  highlights_description text not null,
  highlights_cta_label text not null,
  highlights_cta_path text not null,
  categories_eyebrow text not null,
  categories_title text not null,
  categories_description text not null,
  benefit_one_title text not null,
  benefit_one_caption text not null,
  benefit_two_title text not null,
  benefit_two_caption text not null,
  benefit_three_title text not null,
  benefit_three_caption text not null,
  benefit_four_title text not null,
...
insert into public.storefront_settings (
  ...
  benefit_one_title, benefit_one_caption, benefit_two_title, benefit_two_caption,
  benefit_three_title, benefit_three_caption, benefit_four_title, benefit_four_caption,
  newsletter_title, newsletter_description, footer_description, footer_location, footer_hours
) values (
  true,
  'PEDIDOS DIRETO PELO INSTAGRAM ◆ ATENDIMENTO PERSONALIZADO ◆ TROCAS EM ATÉ 7 DIAS',
  'NOVO DROP — 2026', 'SEU ESTILO.\nSUA PRESENÇA.', 'SUA PRESENÇA.',
  'Moda masculina com atitude e peças selecionadas. Use o cupom BEMVINDO e garanta 5% OFF na primeira compra.',
  ...
  'EXPLORE', 'ENCONTRE SEU ESTILO', 'Uma seleção para cada momento, sempre com a identidade OM.',
  'Pedido pelo Instagram', 'Atendimento direto com a loja',
  'Trocas em até 7 dias', 'Simples e sem burocracia',
  'Suporte especializado', 'Atendimento humanizado',
  'Compra orientada', 'Confirmação antes do Pix',
  'NÃO PERCA O PRÓXIMO DROP',
  'Cadastre seu e-mail e seja o primeiro a receber novidades, peças limitadas e condições especiais.',
  'Peças selecionadas para quem veste autenticidade.',
  E'Joaquim Gomes — AL',
  ''
);
...
create policy "storefront settings: public may read"
on public.storefront_settings for select to anon, authenticated
using (id = true);

create policy "storefront settings: admin may update"
